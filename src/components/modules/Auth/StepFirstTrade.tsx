...
export function StepFirstTrade({ onBack, onNext }: Props) {
  return (
    <div className="flex-1 flex items-start">
      <div className="bg-gray-50 border border-gray-200 rounded-2xl p-12 flex flex-col items-center justify-center text-center w-full">
        {/* Green check */}
        <CheckCircle2 className="w-16 h-16 text-green-500 mb-5" strokeWidth={1.5} />
