        ...
        <div className="flex flex-col gap-10">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-7 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-xl font-bold text-slate-900 dark:text-slate-100 flex gap-1">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            {preferredExchangeTags.map((tag, i) => (
                                <div key={i} className="px-3 py-1.5 rounded-lg border  dark:border-border/60 bg-white dark:bg-card text-[11px] font-bold text-muted-foreground dark:text-slate-300 shadow-sm capitalize">
                                    {tag}
                                </div>
                            ))}
                        </div>
