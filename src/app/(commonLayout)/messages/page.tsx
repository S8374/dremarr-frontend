  ...
  return (
    <div className=" h-[calc(100vh-80px)] overflow-hidden">
      <div className=" max-w-[1440px] mx-auto h-full flex ">
        ...
        <aside 
          data-lenis-prevent
          className="w-[340px] hidden lg:block h-full border-r border-border/10 shrink-0 overflow-y-auto scrollbar-hide"
        >
          <MessagesSidebar />
        </aside>
        ...
        <main 
          data-lenis-prevent
          className="flex-1 h-full min-w-0 bg-background dark:bg-card overflow-hidden"
        >
          <ChatArea />
        </main>
        ...
        <aside 
          data-lenis-prevent
          className="w-[300px] hidden xl:block h-full shrink-0 overflow-y-auto scrollbar-hide"
        >
          <ProfileSidebar />
        </aside>
      </div>
