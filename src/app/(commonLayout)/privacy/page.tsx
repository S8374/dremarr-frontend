    ...
    <div className="min-h-screen font-sans bg-white dark:bg-zinc-950">
      <div className="max-w-[1340px] mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm text-gray-800 dark:text-gray-300 leading-relaxed [&_h2]:text-gray-700 dark:[&_h2]:text-gray-200 [&_p]:text-gray-600 dark:[&_p]:text-gray-300 [&_ul]:text-gray-600 dark:[&_ul]:text-gray-300">
          ...
          {/* 1 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "1. Acerca de Dremarr" : "1. About Dremarr"}</h2>
          ...
          {/* 2 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "2. Elegibilidad" : "2. Eligibility"}</h2>
          ...
          {/* 3 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "3. Registro de cuenta" : "3. Account Registration"}</h2>
            <p className="text-gray-500">
          ...
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "4. Responsabilidades del proveedor" : "4. Skill Provider Responsibilities"}</h2>
          ...
          {/* 5 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "5. Responsabilidades del buscador" : "5. Seeker Responsibilities"}</h2>
          ...
          {/* 6 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "6. Proyectos y pagos" : "6. Projects &amp; Payments"}</h2>
            <ul className="list-disc list-inside space-y-1 pl-2 text-gray-500">
          ...
          {/* 7 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "7. Cancelaciones y reembolsos" : "7. Cancellations &amp; Refunds"}</h2>
            <ul className="list-disc list-inside space-y-1 pl-2 text-gray-500">
          ...
          {/* 8 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "8. Comunicacion" : "8. Communication"}</h2>
            <ul className="list-disc list-inside space-y-1 pl-2 text-gray-500">
          ...
          {/* 9 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "9. Verificacion y confianza" : "9. Verification &amp; Trust"}</h2>
            <ul className="list-disc list-inside space-y-1 pl-2 text-gray-500">
          ...
          {/* 11 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "11. Disponibilidad de la plataforma" : "11. Platform Availability"}</h2>
          ...
          {/* 12 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "12. Limitacion de responsabilidad" : "12. Limitation of Liability"}</h2>
          ...
          {/* 13 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "13. Privacidad y proteccion de datos" : "13. Privacy &amp; Data Protection"}</h2>
            <ul className="list-disc list-inside space-y-1 pl-2 text-gray-500">
          ...
          {/* 14 */}
          <section>
            <h2 className="text-base font-bold text-gray-600 mb-2">{isSpanish ? "14. Cambios en los terminos" : "14. Changes to Terms"}</h2>
